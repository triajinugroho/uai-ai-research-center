...
Log ini mencatat **setiap penggunaan AI yang memengaruhi riset** — desain, pencarian literatur, pemilihan data, kode, eksperimen, analisis, penulisan — sejak W1 (dimulai saat menandatangani AI Research Protocol agreement, G1) sampai submission. Diisi oleh anggota tim yang memakai AI, pada hari yang sama, sebagai `docs/ai-usage-log.md` (atau CSV dengan kolom sama) di repositori riset. Dari log ini disusun **AI Usage Statement** di `docs/AI-USAGE.md`, yang menjadi bagian Research Pack, bagian *AI Usage Disclosure* README riset, dan pernyataan di manuscript. Reviewer memeriksa log pada G3 (verifikasi sumber), G6 (kode berbantuan AI), dan G8 (statement lengkap); log yang tidak lengkap membuat Research Integrity Gate gagal ([TPL-11](11-research-integrity-checklist.md)). Prinsip: AI-augmented, human-accountable — AI adalah research copilot, bukan epistemic authority.
...
## Template log (salin ke `docs/ai-usage-log.md`)
...
## Template AI Usage Statement (salin ke `docs/AI-USAGE.md` dan manuscript)
...
Log lengkap: `docs/ai-usage-log.md` ([n] entri).
```
...
| 7 | 2026-10-[dd] | [coding assistant] | Coding | Debugging parser output LLM | Tempel pesan error + fungsi parser (tanpa data mahasiswa) | Ya | R: patch dibaca baris per baris · E: unit test 12 kasus lulus | Diubah — `src/eval/parse.py` commit `[hash]` | [Mahasiswa B] |
...
| 12 | 2026-11-[dd] | [LLM chat] | Writing | Perbaikan bahasa Inggris abstrak | Tempel draf abstrak, minta koreksi tata bahasa tanpa mengubah isi | Ya | R: dibandingkan kalimat per kalimat; klaim tidak berubah | Diubah — `paper/abstract.md` | [Mahasiswa B] |
