...
|---|---|---|
| **Proyek mata kuliah** | Berjalan di AI/ML, Data Mining, RPL, Proyek Perangkat Lunak; hasilnya dinilai lalu berhenti sebagai nilai | Belum ada artefak riil di [`research-based-learning/courses/`](../../research-based-learning/README.md); diisi mulai GOV-02 Phase 2 (Integrate AI/ML), lengkap pada Phase 3 (Expand technical courses) — GitHub Phase 3 Curriculum Integration ([GOV-02](../07-governance/02-implementation-roadmap.md)) |
