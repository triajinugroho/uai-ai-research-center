...
**Red flags:** kalimat halus tetapi tidak konsisten dengan repositori; sitasi baru di tahap menulis; `AI-USAGE.md` menyebut "membantu" tanpa rincian; anggota tidak bisa menjelaskan paragraf tertentu.
...
| Human accountability | Bisakah saya mempertahankan ini tanpa AI? | Jelaskan ke peer; tulis di `AI-USAGE.md`; tanda tangani TPL-11 | `AI-USAGE.md`, TPL-11, defense |
