...
| 4 | CPL-x: [isi] | **Gap** — menurunkan research gap langsung dari synthesis matrix (Gap–Claim–Evidence alignment) | W5 Gap: studio gap analysis | 5E **Evidence**/**End** | Research Gap statement yang menunjuk baris matriks | `docs/research-question.md` bagian gap; Issue `type:literature-gap` |
