...
Asset rumpun RPL adalah **research-grade software + testing evidence + artifact README**. Kolom "MK" menandai MK mana dalam rumpun yang bertanggung jawab; pengampu boleh menggeser sesuai RPS. File khusus rumpun RPL (`docs/requirements.md`, `docs/testing-evidence.md`, `docs/user-evaluation.md`) adalah tambahan di luar struktur minimum [TPL-15](../../../research-os/08-templates/15-research-repository-template.md); untuk riset yang lanjut ke Metopen, testing evidence dipetakan ke `results/pilot-01/sanity-check.md` dan evaluasi pengguna ke `results/analysis.md`.

## 1. Tabel artefak

| Artefak | MK | Wajib / Opsional | Format & lokasi | Template | ID yang diberikan | Kriteria kualitas | Diserahkan ke | Gate (embrio) |
|---|---|---|---|---|---|---|---|---|
| **Problem/requirement brief** | RPL, Proyek PL | Wajib | `docs/problem.md` + `docs/requirements.md`; menunjuk Issue backlog atau stakeholder | — | ID sementara ([CONTRIBUTING.md §2](../../../CONTRIBUTING.md)) bila lanjut ke riset | Problem-first; keputusan yang berubah; survei alternatif yang sudah ada (reuse before create) | Repo tim; Issue backlog | G2 |
...
| **AI Usage Log + Statement** | Semua | Wajib | `docs/AI-USAGE.md` | [TPL-10](../../../research-os/08-templates/10-ai-usage-log-template.md) | — | Kode bantuan AI diuji; verifikasi dicatat; statement di README | Repo tim | Integrity check |
...
- [ ] `docs/AI-USAGE.md` terisi; [TPL-11](../../../research-os/08-templates/11-research-integrity-checklist.md) ditandatangani; lisensi dependensi diperiksa.
