...
Asset utama Data Mining adalah **pengetahuan tentang dataset** — evidence map dataset dan error analysis — bukan model. Artefak **wajib** menjadi bagian penilaian; **opsional** memperkuat rekomendasi handoff. File khusus MK Data Mining (`docs/dataset-evidence-map.md`, `src/quality_checks.py`) adalah tambahan di luar struktur minimum [TPL-15](../../../research-os/08-templates/15-research-repository-template.md); bila riset lanjut ke Metopen: evidence map → `docs/data-plan.md`, quality checks → `src/data.py`.
...
| **Laporan baseline & pembanding** | Wajib | `results/pilot-01/summary.md` (+ `baseline.json`) + notebook di `notebooks/` | — | — | Baseline sederhana + 1 metode; split/CV benar; ≥ 3 fold/seed; angka baseline direproduksi peer | Repo tim | G6 |
...
| **AI Usage Log** | Wajib | `docs/AI-USAGE.md` | [TPL-10](../../../research-os/08-templates/10-ai-usage-log-template.md) | — | Tool, tujuan, output material, verifikasi, dimasukkan/tidak | Repo tim; lampiran laporan | Integrity check |
...
- [ ] `docs/AI-USAGE.md` terisi; [TPL-11](../../../research-os/08-templates/11-research-integrity-checklist.md) ditandatangani.
...
| Distribusi kelas | Kelas minoritas 8% | `figures/pilot-01/class-dist.png` | Accuracy menyesatkan; pakai F1/PR-AUC + baseline majority |
