...
Asset utama MK/topik NLP adalah **korpus/anotasi kecil + benchmark**. Korpus fisik yang sensitif disimpan di luar GitHub; repo menyimpan kartu, guideline, skrip, dan hasil ([SECURITY.md](../../../SECURITY.md)). File khusus MK NLP (`docs/annotation-guideline.md`, `docs/agreement.md`) adalah tambahan di luar struktur minimum [TPL-15](../../../research-os/08-templates/15-research-repository-template.md); bila riset lanjut ke Metopen, keduanya dirujuk dari `docs/data-plan.md` §Annotation.
...
| **AI Usage Log** | Wajib | `docs/AI-USAGE.md`; bagian khusus *pra-anotasi AI* (jumlah label AI, % dikoreksi manusia) | [TPL-10](../../../research-os/08-templates/10-ai-usage-log-template.md) | — | AI tidak dihitung sebagai anotator; setiap label AI diverifikasi; tingkat koreksi dilaporkan | Repo tim | Integrity check |
| **Research One-Pager v0** | Opsional (wajib bila lanjut) | `docs/one-pager.md` | [TPL-01](../../../research-os/08-templates/01-research-one-pager-template.md) | ID sementara ([CONTRIBUTING.md §2](../../../CONTRIBUTING.md)) | Problem-first; baseline dan metrik tercantum | Issue backlog; handoff ke Metopen | G2, G7 |
...
- [ ] `docs/AI-USAGE.md` memuat bagian pra-anotasi AI; [TPL-11](../../../research-os/08-templates/11-research-integrity-checklist.md) ditandatangani.
...
| Benchmark baseline CRF vs [model] | `proj-YYYY-[topik]/results/pilot-01/summary.md` | — | F1 per kelas, 3 seed; direproduksi tim [isi] |
