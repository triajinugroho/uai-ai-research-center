...
**Status** Draft v0.1 (2026-09) · GitHub Phase 3 Curriculum Integration (GOV-02 Phase 3 Expand technical courses) — nama MK resmi, semester, SKS `[isi]`; artefak riil menyusul
