...
| Issue Research Problem awal dengan Research ID sementara | Issue `type:problem` di repo pusat (form [Research Problem](../../.github/ISSUE_TEMPLATE/01-research-problem.yml)); nomor Issue dicantumkan di `README.md` §Current Research Gate | Issue terbuka + commit README | OPS-011 |
...
| AI Research Protocol Agreement tertandatangani | `docs/ai-protocol-agreement.md` ([AIX-04](../../research-os/05-ai-augmented-research/04-ai-research-protocol.md) §5) | commit | OPS-013 (bukti wajib G1) |
| AI Usage Log W1 + AI Usage Statement awal | `docs/ai-usage-log.md` dan `docs/AI-USAGE.md` ([TPL-10](../../research-os/08-templates/10-ai-usage-log-template.md)) | commit | OPS-014 |
...
Struktur folder standar (`docs/`, `data/README.md`, `src/`, `notebooks/`, `experiments/`, `results/`, `figures/`, `paper/`, `presentation/`) sudah dibuat di S0 (OPS-005); minggu ini cukup dipastikan ada dan README riset memuat judul kerja, tim, dan `Current Research Gate: G1`.
...
- [ ] Issue `type:problem` terbuka dengan Research ID sementara; nomornya tercantum di README riset §Current Research Gate.
...
- [ ] `docs/ai-usage-log.md`, `docs/AI-USAGE.md`, dan `docs/journal/w01.md` ter-commit.
