...
| §Gap Candidates: 2–3 kandidat gap, masing-masing dengan jenis gap dan baris matriks pendukung; hasil pencarian ulang setelah tantangan AI dicatat di `docs/literature/search-log.csv` | `docs/literature-map.md` §Gap Candidates ([MET-04](../../research-os/04-metopen-research-studio/04-research-pack-specification.md) §4 menyediakan `docs/gap.md` — boleh dipakai sebagai penunjuk ke bagian ini; jangan dua salinan berbeda isi) | commit | OPS-045 |
...
| AI Usage Log W5: entri Stage `Synthesis` dan `Gap` — pengelompokan baris, kritik alur argumen, tantangan gap dan hasil pencarian ulangnya, ringkasan slide | `docs/ai-usage-log.md`, ringkasan di `docs/AI-USAGE.md` ([TPL-10](../../research-os/08-templates/10-ai-usage-log-template.md)) | commit | OPS-049 |
...
- [ ] `docs/ai-usage-log.md` memuat entri Stage `Synthesis`/`Gap`; tiap anggota sudah memverifikasi entrinya; `docs/AI-USAGE.md` diperbarui.
